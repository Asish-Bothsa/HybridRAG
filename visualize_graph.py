...
def main():
    # Create the driver inside a context manager so it will be closed
    # deterministically before interpreter shutdown. This avoids destructor
    # code running during shutdown when modules may already be cleared.
